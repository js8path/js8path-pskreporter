...
module.exports = [
  {
    ...
    output: {
      ...
      filename: 'js8path-pskreporter-webtest-unit.js'
    },
    devServer: {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        filename: 'js8path-pskreporter-webtest-unit.html',
        template: 'test/unit/template-test.html',
        title: 'Mocha Unit Tests for js8path-pskreporter (from template)',
        minify: false,
        inject: false,
        hash: true
      })
